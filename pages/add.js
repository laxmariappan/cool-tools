            ...
            <div>
              ...
              >
                <label className="name">
                  ...
                  <input
                    {...register("name")}
                    className="form-input border-gray-100"
                    id="name"
                    name="name"
                    type="text"
                ...
                <label className="description">
                  ...
                  <textarea
                    ...
                    id="description"
                    name="description"
                    placeholder="Removes background from photos"
                  ></textarea>
                </label>
                      ...
                      <>
                        <div key={menu}>
                          <input
                            ...
                            {...register("tags", {})}
                          />
                          <label htmlFor={menu} className="pl-2 ">
                            {menu}
                          </label>
                        </div>
                      </>
                ...
                <input
                  type="submit"
                  className="w-full btn bg-purple-700 btn-lg text-white"
                  value="Add Tool"
                />
                ...
                <div className="flex space-x-3 ">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-700">
                      Add any tool that you find useful
                    </p>
                  </div>
                </div>
                <div className="flex space-x-3">
